...
class ProfileUmumController extends Controller
{
    public function __construct()
    {
        $this->middleware('auth.umum')->only(['index', 'show']);
    }
    /**
    ...
    public function index()
    {
        ...
        return view('public.layouts.features', $this->dataView);
    }
    ...
    {
        $this->dataView['umum'] = Umum::where('user_id', $id)->first();
        ...
        return view('public.main.profile_public.index', $this->dataView);
    }
    ...
    public function update(Request $request, $id)
    {
        if ($request->hasFile('file')) { // Jika foto ada
            ...
            Umum::where('user_id', $id)->update([
                'nama' => $request->nama,
                'umur'  => $request->umur,
                'alamat'  => $request->alamat,
                'kota' => $request->kota,
                'negara' => $request->negara,
                'path_foto' => $request->file->store('images/profile/umum', 'public')
            ]);
