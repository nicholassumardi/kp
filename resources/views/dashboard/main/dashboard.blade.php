        ...
        <div class="col">
            <div class="card">
                            ...
                            <tr>
                                <th scope="row">
                                    <div class="media-body">
                                        <span class="name mb-0 text-sm">ILC Week 1</span>
                                    </div>
                </div>
                </th>
                <td class="budget">
                ...
                <tr>
                    <th scope="row">
                        <div class="media-body">
                            <span class="name mb-0 text-sm">ILC Week 4</span>
                        </div>
                ...
                <tr>
                    <th scope="row">
                        <div class="media-body">
                            <span class="name mb-0 text-sm">TOEFL</span>
                        </div>
                ...
                <tr>
                    <th scope="row">
                        <div class="media align-items-center">
                            <div class="media-body">
                                <span class="name mb-0 text-sm">ILC Week 14</span>
                            </div>
                        </div>
                    </th>
                    <td class="budget">
                ...
                <tr>
                    <th scope="row">
                        <div class="media align-items-center">
                            <div class="media-body">
                                <span class="name mb-0 text-sm">IELTS</span>
                            </div>
                        </div>
                    </th>
                    <td class="budget">
