...
<div class="container">
    ...
    <div class="row justify-content-md-center" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="1400">
        ...
        <div class="col-md-auto mt-5">
            <div class="card" style="width: 50vw;">
                <div class="card-body">
                    ...
                    <a href="{{route('news.show', $databerita->id_berita)}}" class="btn btn-primary">See More</a>
                </div>
            </div>
        </div>
        @endforeach
