    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <form action="{{ route('penerjemahan-public.store') }}" method="POST" enctype="multipart/form-data" id="form-penerjemahan">
                    @csrf
                    ...
                    <div class="row mt-3 mb-5 justify-content-center" id="div-abstrak">
                        <div class="col-xl-10">
                            ...
                            <input class="form-control customicon input-file" type="file" name="path_file_abstrak_umum" required>
                            <small class="form-text text-muted">
                    ...
                    <div class="row mt-3 mb-5 justify-content-center d-none" id="div-jurnal">
                        <div class="col-xl-10">
                            ...
                            <input class="form-control customicon input-file" type="file" name="path_file_jurnal_umum">
                            <small class="form-text text-muted">
                                * File harus dalam format word (doc, docx).
                                <br>
