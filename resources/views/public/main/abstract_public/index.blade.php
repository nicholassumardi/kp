...
<div class="container-fluid mt--6">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between">
            ...
            <a href="{{route('penerjemahan-public.create')}}" class="btn btn-primary btn-sm">Kirim Penerjemahan</a>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered invisible" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {{ basename(substr($abstract->path_file_abstrak_umum
                                ,0,strpos($abstract->path_file_abstrak_umum ,
                                "{}"))) ? basename(substr($abstract->path_file_abstrak_umum
                                ,0,strpos($abstract->path_file_abstrak_umum ,
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                {{basename(substr($jurnal->path_file_jurnal_umum
                                ,0,strpos($jurnal->path_file_jurnal_umum ,
                                "{}"))) ? basename(substr($jurnal->path_file_jurnal_umum
                                ,0,strpos($jurnal->path_file_jurnal_umum ,
