                ...
                <div class="card card-profile">
                    ...
                    <div class="row justify-content-center mb-5">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="{{ asset('storage/' . $umum->path_foto) }}"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="text-center mt-5">
                            <h5 class="h3">
                                {{$umum->nama}}<span class="font-weight-light">, {{$umum->umur}}</span>
                            </h5>

                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ $umum->kota }}, {{ $umum->negara }}
                            </div>
                            <div>
                        ...
                        <form>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control" placeholder="Full Name"
                                                value="{{$umum->nama}}" name="nama" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="age" class="form-control" placeholder="Age"
                                                value="{{$umum->umur}}" name="umur" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="input-address" class="form-control" placeholder="Home Address"
                                                value="{{$umum->alamat}}" type="text" name="alamat" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="input-city" class="form-control" placeholder="City"
                                                value="{{$umum->kota}}" name="kota" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="input-country" class="form-control"
                                                placeholder="Country" value="{{$umum->negara}}" name="negara" required>
                                        </div>
                                    </div>
                            ...
                            <div class="d-flex flex-column justify-content-center">
                                <div class="row mb-5 mx-auto">
                                    <div class="col">
                                        <img src="{{ asset('storage/' . $umum->path_foto) }}"
                                            class="rounded-circle customprofilepicture" id="profile-picture-view" data-old-src="{{ asset('storage/' . $umum->path_foto) }}">
                                    </div>
                                </div>
